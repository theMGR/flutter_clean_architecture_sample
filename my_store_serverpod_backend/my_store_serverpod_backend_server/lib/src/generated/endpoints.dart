...
import '../endpoints/mobile_auth_endpoints.dart' as _i11;
...
class Endpoints extends _i1.EndpointDispatch {
  ...
  void initializeEndpoints(_i1.Server server) {
    var endpoints = <String, _i1.Endpoint>{
      ...
      'mobileAuthEndPoint': _i11.MobileAuthEndPoint()
        ..initialize(
          server,
          'mobileAuthEndPoint',
          null,
        ...
        'createActivity': _i1.MethodConnector(
          ...
          params: {
            'activity': _i1.ParameterDescription(
              name: 'activity',
              type: _i1.getType<_i14.Activity>(),
              nullable: false,
            )
          },
          call: (
        ...
        'getActivities': _i1.MethodConnector(
          ...
          params: {
            'crd': _i1.ParameterDescription(
              name: 'crd',
              type: _i1.getType<_i15.Cardlist>(),
              nullable: false,
            )
          },
          call: (
        ...
        'addAttachment': _i1.MethodConnector(
          ...
          params: {
            'attachment': _i1.ParameterDescription(
              name: 'attachment',
              type: _i1.getType<_i16.Attachment>(),
              nullable: false,
            )
          },
          call: (
        ...
        'createChecklist': _i1.MethodConnector(
          ...
          params: {
            'checklist': _i1.ParameterDescription(
              name: 'checklist',
              type: _i1.getType<_i18.Checklist>(),
              nullable: false,
            )
          },
          call: (
        ...
        'createList': _i1.MethodConnector(
          ...
          params: {
            'lst': _i1.ParameterDescription(
              name: 'lst',
              type: _i1.getType<_i20.Listboard>(),
              nullable: false,
            )
          },
          call: (
        ...
        'getInformationOfMembers': _i1.MethodConnector(
          ...
          params: {
            'members': _i1.ParameterDescription(
              name: 'members',
              type: _i1.getType<List<_i21.Member>>(),
              nullable: false,
            )
          },
          call: (
        ...
        'deleteMember': _i1.MethodConnector(
          ...
          params: {
            ...
            'workspace': _i1.ParameterDescription(
              name: 'workspace',
              type: _i1.getType<_i22.Workspace>(),
              nullable: false,
            ),
          },
          call: (
        ...
        'addMobileAuth': _i1.MethodConnector(
          ...
          params: {
            'input': _i1.ParameterDescription(
              name: 'input',
              type: _i1.getType<_i23.MobileAuthModel>(),
              nullable: false,
            )
          },
          call: (
            ...
            Map<String, dynamic> params,
              ...
              (endpoints['mobileAuthEndPoint'] as _i11.MobileAuthEndPoint)
                  .addMobileAuth(
            session,
            params['input'],
          ),
        ...
        'createUser': _i1.MethodConnector(
          ...
          call: (
            ...
            Map<String, dynamic> params,
              ...
              (endpoints['user'] as _i12.UserEndpoint).createUser(
            session,
            params['user'],
          ),
        ),
        'getUserById': _i1.MethodConnector(
          ...
          call: (
            ...
            Map<String, dynamic> params,
              ...
              (endpoints['user'] as _i12.UserEndpoint).getUserById(
            session,
        ...
        'checkUserExists': _i1.MethodConnector(
          ...
          call: (
            ...
            Map<String, dynamic> params,
              ...
              (endpoints['user'] as _i12.UserEndpoint).checkUserExists(
            session,
            params['existinguser'],
          ),
        ),
        ...
        'createWorkspace': _i1.MethodConnector(
          ...
          call: (
            ...
            Map<String, dynamic> params,
              ...
              (endpoints['workspace'] as _i13.WorkspaceEndpoint)
                  .createWorkspace(
            session,
            params['workspace'],
          ),
