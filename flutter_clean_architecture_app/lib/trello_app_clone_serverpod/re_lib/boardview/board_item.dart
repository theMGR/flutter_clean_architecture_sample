...
class BoardItem extends StatefulWidget {
  ...
  const BoardItem({super.key, this.boardList, this.item, this.index, this.onDropItem, this.onTapItem, this.onStartDragItem, this.draggable = true, this.onDragItem});
