...
import 'package:flearn/f_praticals/source/config/api/dio_interceptor.dart';
import 'package:flearn/f_praticals/source/config/api/isolate_parser.dart';
import 'package:flearn/f_praticals/source/config/error/failure.dart';
import 'package:flearn/f_praticals/source/config/service/firebase/firebase_crashlogger.dart';
import 'package:flearn/f_praticals/source/config/utils/either.dart';
...
class DioClient with /*MainBoxMixin,*/ FirebaseCrashLogger {
  ...
  Future<Either<Failure, T>> postRequest<T>(
    ...
    try {
      ...
      final isolateParse = IsolateParser<T>(response.data as Map<String, dynamic>, converter);
      final result = await isolateParse.parseInBackground();
      return Either.right(result);
    } on DioException catch (e, stackTrace) {
      if (!_isUnitTest) {
