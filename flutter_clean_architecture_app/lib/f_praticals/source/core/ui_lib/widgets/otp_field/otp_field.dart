...
/* credits: https://pub.dev/packages/otp_text_field
* */
...
class OTPTextField extends StatefulWidget {
  ...
  /// The style to use for the hint text being edited.
...
class _OTPTextFieldState extends State<OTPTextField> {
  ...
  void initState() {
    ...
    if (widget.textControllers != null && widget.textControllers!.length == widget.length) {
