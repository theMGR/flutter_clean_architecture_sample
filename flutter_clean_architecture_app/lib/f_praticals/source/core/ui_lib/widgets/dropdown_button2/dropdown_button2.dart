...
class DropdownButton2State<T> extends State<DropdownButton2<T>> with WidgetsBindingObserver {
  ...
  TextStyle? get _textStyle => widget.style ?? Theme.of(context).textTheme.headlineMedium;
  ...
  double get _denseButtonHeight {
    ...
    final double fontSize = _textStyle!.fontSize ?? Theme.of(context).textTheme.headlineMedium!.fontSize!;
