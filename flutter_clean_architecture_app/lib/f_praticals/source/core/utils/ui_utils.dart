...
import 'package:flearn/f_praticals/source/config/widgets/faddingprogress.dart';
...
import 'package:flearn/f_praticals/source/core/ui_lib/widgets/retry_widget/retry_widget.dart';
import 'package:flearn/f_praticals/source/core/utils/input_type_utils.dart';
...
class UIUtils {
  ...
  static Widget buttonLoading({bool? dark}) {
    return SizedBox(
      width: Dimensions.width5 * 6,
      height: Dimensions.height5 * 6,
      child: Center(
        child: CircularProgressIndicator.adaptive(
          valueColor: AlwaysStoppedAnimation<Color>(dark == true ? ColorConstant.blackColor : Colors.white),
        ),
      ),
    );
  }
        ...
        builder: (context, setState) {
          ...
          setState(() {
            ...
            if (_selectedDate.trim().length > 0 && selectedDate.trim().length > 0) {
              ...
              textEditingController.text = DatesUtils.formatDate(_selectedDate, UIConstants.DATE_FORMAT_DDMMYYYY_SLASH) ?? "";
            }
          });
              ...
              if (pickedDateTime != null && pickedDateTime != _selectedDateTime) {
                setState(() {
                  ...
                  if (onServerDate != null) {
                    onServerDate(DatesUtils.formatDate(_selectedDate, UIConstants.DATE_FORMAT_SERVICE_Z));
                  }

                  if (onYYYYMMDDHHMMSS != null) {
                    onYYYYMMDDHHMMSS(DatesUtils.formatDate(_selectedDate, UIConstants.DATE_FORMAT_YYYYMMDDHHMMSS));
                  }

                  if (onDDMMYYYYSlash != null) {
                    onDDMMYYYYSlash(DatesUtils.formatDate(_selectedDate, UIConstants.DATE_FORMAT_DDMMYYYY_SLASH));
                  }
  ...
  static void showAlertDialog({required BuildContext? context, required String alertTitle, required String alertMessage, bool isBarrierDismissible = true}) {
    if (context != null) {
      ...
      Widget okButton = ElevatedButton(
        style: ElevatedButton.styleFrom(foregroundColor: Colors.white, backgroundColor: ColorConstant.Btn_color),
        child: Text("OK",style: TextStyle(fontFamily: ReleaseConstant.Prosto)),
        onPressed: () {
      ...
      AlertDialog alert = AlertDialog(
        ...
        content: SingleChildScrollView(child: Text(alertMessage,style: TextStyle(fontFamily: ReleaseConstant.Montserrat),)),
        actions: [
          okButton,
        ],
      );
...
/*              child: RichText(text: TextSpan(
  ...
  static Widget appProgress({String message = ""}) {
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  message,
                  style: TextStyle(fontFamily: ReleaseConstant.Montserrat),
                )
              ],
            ),
          ),
            ...
            child: Container(
              ...
              child: Material(
                ...
                child: Column(
                  ...
                  children: [
                    Row(children: [
                      Expanded(child: Text("", style: TextStyle(fontSize: 16, color: ColorConstant.blue_1, fontFamily: ReleaseConstant.Montserrat))),
...
/*    Get.bottomSheet(
  ...
  static KeyboardVisibilityBuilder keyboardVisibilityBuilder(Widget? child) {
    return KeyboardVisibilityBuilder(builder: (context, isKeyboardVisible) {
      ...
      return AnimatedContainer(height: isKeyboardVisible ? 0 : null, duration: Duration(milliseconds: 500), curve: Curves.fastOutSlowIn, child: child ?? SizedBox());
