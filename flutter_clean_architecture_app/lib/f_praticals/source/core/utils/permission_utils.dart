...
import 'package:flearn/f_praticals/source/constants/key_constant.dart';
...
import 'package:flearn/f_praticals/source/core/utils/ui_config.dart';
...
/*      showDialog(
  ...
  static Future<bool> getStoragePermissionStatusForMobile() async{
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        InkWell(
                          key: ValueKey(KeyConstant.alert_btn_notification_permission),
