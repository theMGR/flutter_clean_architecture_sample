...
class FutureBuilderPractical extends StatefulWidget {
  const FutureBuilderPractical({super.key});

  @override
  State<FutureBuilderPractical> createState() => _FutureBuilderPracticalState();
}

class _FutureBuilderPracticalState extends State<FutureBuilderPractical> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(title: const Text("Future Builder Practical")),
        body: FutureBuilder<ApiResponseDTO>(
          future: RepoImpl.fetchPhotos(),
