...
import 'package:flearn/flutter_architecture_sample/layers/presentation/shared/character_list_item_header.dart';
import 'package:flearn/flutter_architecture_sample/layers/presentation/shared/character_list_item_loading.dart';
import 'package:flearn/flutter_architecture_sample/layers/presentation/using_riverpod/details_page/view/details_page.dart';
import 'package:flearn/flutter_architecture_sample/layers/presentation/using_riverpod/list_page/notifier/character_page_state.dart';
import 'package:flearn/flutter_architecture_sample/layers/presentation/using_riverpod/list_page/notifier/character_state_notifier.dart';
...
class _CharacterViewState extends ConsumerState<CharacterView> {
  ...
  Widget build(BuildContext context) {
    ...
    return status == CharacterPageStatus.initial ? const Center(child: CircularProgressIndicator()) : const _Content();
  }
}
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              if (index >= list.length) {
                return !hasEnded ? const CharacterListItemLoading() : const SizedBox();
              }
