...
class FilePickerUtils {
        ...
        if (type == TYPE.CAMERA) {
          if (maxWidth != null && maxHeight != null && maxWidth > 100 && maxHeight > 100) {
            ...
            if (xFile != null) {
              ...
              if(imageCrop) {
                var croppedFile = await getCroppedFile(
  ...
  static Future<CroppedFile?> getCroppedFile({required String sourcePath, int? maxHeight, int? maxWidth, int compressQuality = 90}) async {
    ...
    AndroidUiSettings androidUiSettings = AndroidUiSettings(
        ...
        toolbarColor: ColorConstant.buttonColor,
  ...
  static Future<List<XFile>?> _showCameraMultiImageDialog(
    ...
    return Get.defaultDialog(
        ...
        titleStyle: TextStyle(color: Colors.black, fontSize: 25, fontWeight: FontWeight.bold, fontFamily: ValueConstant.Montserrat),
        ...
        content: Column(
          children: [
            UIUtils.buttonWidthSize(
                ...
                width: 160,
                fillColor: ColorConstant.buttonColor,
  ...
  static Future<List<XFile>?> _showCameraImageDialog(
    ...
    return Get.defaultDialog(
        ...
        titleStyle: TextStyle(color: Colors.black, fontSize: 20, fontWeight: FontWeight.bold, fontFamily: ValueConstant.Montserrat),
        middleTextStyle: TextStyle(color: Colors.black54),
        //textConfirm: "Confirm",
        //textCancel: "Cancel",
        cancelTextColor: Colors.red,
